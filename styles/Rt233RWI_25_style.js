...
var style_Rt233RWI_25 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value >= 0.240000 && value <= 0.292800) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 18.8 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.292800 && value <= 0.346400) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 18.8 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.346400 && value <= 0.401600) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 18.8 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.401600 && value <= 0.439600) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 18.8 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.439600 && value <= 0.469000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 18.8 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.469000 && value <= 0.757600) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 18.8 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.757600 && value <= 0.953600) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 18.8 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.953600 && value <= 0.964400) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 18.8 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.964400 && value <= 0.993200) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 18.8 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.993200 && value <= 1.031000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 18.8 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1.031000 && value <= 1.097000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 18.8 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1.097000 && value <= 1.169000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 18.8 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1.169000 && value <= 1.253000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 18.8 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1.253000 && value <= 1.344200) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 18.8 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1.344200 && value <= 1.439000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 18.8 + size, points: 4,
